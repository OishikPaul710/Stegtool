...
def encode():
    ...
    Label(enc, text="ENCRYPTION", bg="grey", width="300", height="3", font=("Calibre", 13)).pack()
    ...
    label2 = Label(enc, text="Final name:", bd=3, font=('', 10))
    ...
    buttonselect = Button(enc, text="Select File",fg="black",bg="white" ,bd=3, font=('', 11), command=openfile)
...
def stegit():
    ...
    Label(stg, text="STEGTOOL", bg="black", fg="white", width="300", height="3", font=("Calibre", 13)).pack()
    Label(stg, text="").pack()
    Label(stg, text="").pack()
...
class main:
    ...
    def login(self):
        ...
        if result:
            ...
            Label(text="Login Successful !", width="30", height="3", font=("Calibre", 13)).pack()
    ...
    def widgets(self):
        self.head = Label(self.master, text='STEGTOOL',fg="white",bg="black", font=('', 40), padx=100,pady=10)
        self.head.pack()
        ...
        Button(self.logf, text=' Login ', bd=5, font=('', 15), bg="black", fg="white", padx=5, pady=5, command=self.login).grid()
        Button(self.logf, text=' Register ', bd=5, font=('', 15),bg="black", fg="white",  padx=5, pady=5, command=self.cr).grid(row=2, column=1)
        self.logf.pack()
